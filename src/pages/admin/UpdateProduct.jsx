    ...
    <Layout title={"Dashboard -Create Product"}>
     ...
     <div className="row">
            ...
            <div className="m-1">
              ...
              <div className="mb-3">
                    <input type="text" value={description} placeholder='Write the description' className='form-control' onChange={(f)=>setDescription(f.target.value)} />

              </div>
              <div className="mb-3">
                    <input type="text" value={price} placeholder='Write a price' className='form-control' onChange={(f)=>setPrice(f.target.value)} />

              </div>
              <div className="mb-3">
                    <input type="text" value={quantity} placeholder='Write a qty' className='form-control' onChange={(f)=>setQuantity(f.target.value)} />
