...
const handleUpdate=async(e)=>{
  e.preventDefault()
try{
  const{data}=await axios.put(`http://localhost:3000/api/v1/category/update-category/${selected._id}`,{name:updateName})
...
try{
  const{data}=await axios.delete(`http://localhost:3000/api/v1/category/delete-category/${pid}`,{name:updateName})
  console.log("data bavlue is ",data.success)
  if(data.success){
